    ...
    <section id="portada" ref={ref1}>
      <div className="portada__container">
        <div className="portada__text">
          <p>
            <FormattedMessage id="app.hi" defaultMessage="Hi there" />
          </p>
          <h1>
            <FormattedMessage
              id="app.name"
          ...
          <div className="portada__buttons">
            ...
            >
              <p>
                <FormattedMessage id="portada.cv" defaultMessage="Resume" />
              </p>{" "}
              <AiOutlineDownload />
            </a>
      ...
      <div className="links">
        <a
          aria-label="Read more about me in my profile on LinkedIn"
        ...
        <a
          aria-label="See more projects in my profile on Github"
        ...
        <a
          aria-label="You can contact to me on Telegram"
          href="https://telegram.me/lamc1058"
          target="_blank"
          rel="noopener noreferrer"
        >
          <BsTelegram />
